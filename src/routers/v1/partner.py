...
from src.routers.docs.partners import register_as_partner, upgrade_to_partner
from src.routers.v1.dependencies import (
    create_partner_user_does_not_exist_service,
    create_partner_user_exists_service)
from src.routers.v1.requests.partners import PartnerIn, UserPartnerIn
from src.routers.v1.responses.partners import PartnerOut
